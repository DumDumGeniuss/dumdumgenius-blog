...
var Diaries = function (_React$Component) {
    ...
    _createClass(Diaries, [{
        ...
        value: function queryDiariesByCategory(category) {
            ...
            _firebase2.default.database().ref('diaries').child(category + '/datas').orderByChild('date').once('value').then(function (result) {
        ...
        value: function getDiariesInfo() {
            ...
            _firebase2.default.database().ref('diariesInfo').once('value').then(function (result) {
